...
public class DoubleLinkedListTester {
	...
	public static void main(String[] args) {
		...
		DoubleDoubleLLPointers ddList = new DoubleDoubleLLPointers();
	...
	public static boolean insertAndContainsTest(DoubleDoubleLLPointers ddList)
	{
	...
	public static boolean deleteTest(DoubleDoubleLLPointers ddList)
	{
	...
	public static boolean modifyingValuesTest(DoubleDoubleLLPointers ddList)
	{
	...
	public static boolean valuesMatch(DoubleDoubleLLPointers ddList, double[] testVals)
	{
